    ...
    <ol className="list-decimal list-outside pl-5">
      ...
      <li className="mb-1">
        ...
        <ol className="list-disc pl-5">
          <li className="mb-1">80% of the ETH balance stored in the contract.</li>
          <li className="mb-1">100 GTN (ERC20) tokens.</li>
        </ol>
      </li>
      <li className="mb-1">
        If the guess is incorrect, the player loses, and the 0.001 ETH fee stays in the contract.
      </li>
    </ol>
  </div>
  );
